...
def main():
    opensearch_url = "https://vpc-apt0002-os-pdn-co-01-vdql7pb6ek2ue5jzm4y6xmcr4u.us-east-1.es.amazonaws.com"
    ...
    if response_allocation:
        ...
        print(f"\nTamaño total store de los índices creados Control en las últimas 24 horas: {total_size_gb:.2f} GB\n")
