...
# Clave KMS con la que se cifrará el Log Group de Cloudwatch
# Para este ejemplo no se cifrarán los logs de API Gateway
kms_key_id = null
...
vpce_id = ["vpce-031ba1e8e7e2558cd", "vpce-080521077c55f0d5d"]
